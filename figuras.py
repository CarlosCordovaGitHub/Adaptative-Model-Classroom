...
# ============================================================================
# FIGURA 1: CONVERGENCIA θ REAL vs θ̂ ESTIMADO
# ============================================================================
...
def figura_1_convergencia():
    ...
    ax.plot([lim_min, lim_max], [lim_min, lim_max], 
            ...
            label='Estimación perfecta (θ̂ = θ)')
    ...
    ax.set_ylabel('Habilidad Estimada (θ̂)', fontsize=13, fontweight='bold')
    ax.set_title('Figura 1: Convergencia de la Estimación de Habilidad Latente\n' +
                'Comparación entre θ Real y θ̂ Estimado por EAP',
    ...
    cbar.set_label('Error Absoluto |θ - θ̂|', rotation=270, labelpad=20, fontsize=11)
    ...
    plt.tight_layout()
    plt.savefig(OUTPUT_DIR / 'figura_1_convergencia.png', dpi=300, bbox_inches='tight')
    plt.savefig(OUTPUT_DIR / 'figura_1_convergencia.pdf', bbox_inches='tight')
    print("✓ Figura 1 generada: figura_1_convergencia.png")
    plt.close()
...
def figura_2_evolucion_se():
    ...
    plt.tight_layout()
    plt.savefig(OUTPUT_DIR / 'figura_2_evolucion_se.png', dpi=300, bbox_inches='tight')
    plt.savefig(OUTPUT_DIR / 'figura_2_evolucion_se.pdf', bbox_inches='tight')
    print("✓ Figura 2 generada: figura_2_evolucion_se.png")
    plt.close()
...
def figura_3_histograma_items():
    ...
    plt.tight_layout()
    plt.savefig(OUTPUT_DIR / 'figura_3_histograma_items.png', dpi=300, bbox_inches='tight')
    plt.savefig(OUTPUT_DIR / 'figura_3_histograma_items.pdf', bbox_inches='tight')
    print("✓ Figura 3 generada: figura_3_histograma_items.png")
    plt.close()
...
def figura_4_equidad():
    ...
    plt.tight_layout()
    plt.savefig(OUTPUT_DIR / 'figura_4_equidad.png', dpi=300, bbox_inches='tight')
    plt.savefig(OUTPUT_DIR / 'figura_4_equidad.pdf', bbox_inches='tight')
    print("✓ Figura 4 generada: figura_4_equidad.png")
    plt.close()
...
def figura_6_decay():
    ...
    plt.tight_layout()
    plt.savefig(OUTPUT_DIR / 'figura_6_decay.png', dpi=300, bbox_inches='tight')
    plt.savefig(OUTPUT_DIR / 'figura_6_decay.pdf', bbox_inches='tight')
    print("✓ Figura 6 generada: figura_6_decay.png")
    plt.close()
